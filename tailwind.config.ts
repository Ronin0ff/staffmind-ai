  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        grid: "radial-gradient(circle at 1px 1px, rgba(20,184,166,0.08) 1px, transparent 0)",
      },
      borderRadius: {
        lg: "var(--radius)",
      ...
      boxShadow: {
        glow: "0 0 0 1px rgba(20,184,166,.25), 0 10px 40px -10px rgba(20,184,166,.35)",
        card: "0 8px 30px rgba(2,6,23,.45)",
      },
      fontFamily: {
